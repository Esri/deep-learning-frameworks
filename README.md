...
-------------|---------|------------
[absl-py](https://abseil.io/) | 2.3.1 | Abseil Python Common Libraries
accelerate | 1.13.0 | Accelerate provides access to numerical libraries optimized for performance on Intel CPUs and NVidia GPUs
...
[aiodns](https://github.com/aio-libs/aiodns) | 3.6.1 | Simple DNS resolver for asyncio
[aiohappyeyeballs](https://aiohappyeyeballs.readthedocs.io) | 2.6.1 |  Async Happy Eyeballs for pre-resolved hosts
[aiohttp](https://github.com/aio-libs/aiohttp) | 3.13.5 | Async http client/server framework (asyncio)
...
[alembic](https://bitbucket.org/zzzeek/alembic) | 1.18.4 | A database migration tool for SQLAlchemy
...
[arcgis-dlpk](https://anaconda.org/esri-build/arcgis-dlpk) | 3.7 | A collection of the essential packages to work with dlpks and the ArcGIS Learn module.
[arviz](https://github.com/arviz-devs/arviz) | 0.20.0 | Exploratory analysis of Bayesian models with Python
[bitsandbytes](https://huggingface.co/docs/bitsandbytes) | 0.49.1 | Accessible large language models via k-bit quantization for PyTorch.
[boto3](https://aws.amazon.com/sdk-for-python) | 1.42.61 | Amazon Web Services SDK for Python
[botocore](http://aws.amazon.com/sdk-for-python/) | 1.42.61 | Low-level, data-driven core of boto 3
[branca](https://github.com/python-visualization/branca) | 0.8.1 | Generate rich HTML + JS elements from Python
[brotli](http://github.com/google/brotli) | 1.2.0 | Brotli compression format
...
[charls](https://github.com/team-charls/charls) | 2.4.3 | CharLS, a C++ JPEG-LS library implementation
...
[cloudpathlib](https://github.com/drivendataorg/cloudpathlib) | 0.23.0 | pathlib.Path-style classes for interacting with files in different cloud storage services.
...
[cuda-cudart](https://developer.nvidia.com/cuda-toolkit) | 12.9.79 | CUDA Runtime Native Libraries
[cuda-cudart_win-64](https://developer.nvidia.com/cuda-toolkit) | 12.9.79 | CUDA Runtime architecture dependent libraries
[cuda-cupti](https://developer.nvidia.com/cuda-toolkit) | 12.9.79 | Provides libraries to enable third party tools using GPU profiling APIs.
[cuda-nvrtc](https://developer.nvidia.com/cuda-toolkit) | 12.9.86 | NVRTC native runtime libraries
[cuda-version](https://developer.nvidia.com/cuda-toolkit) | 12.9 | A meta-package for pinning to a CUDA release version
[cudnn](https://developer.nvidia.com/cudnn) | 9.10.2.21 | NVIDIA's cuDNN deep neural network acceleration library
[cumm](https://github.com/FindDefinition/PCCM) | 0.8.2 | CUda Matrix Multiply library
...
[cython](http://www.cython.org/) | 3.2.4 | The Cython compiler for writing C extensions for the Python language
...
[deep-learning-essentials](https://github.com/esri/deep-learning-frameworks) | 3.7 | Expansive collection of deep learning packages
...
[diffusers](https://github.com/huggingface/diffusers) | 0.36.0 | Diffusers provides pretrained diffusion models
...
[eigen](http://eigen.tuxfamily.org/) | 3.4.0 | C++ template library for linear algebra
...
[eval-type-backport](https://github.com/alexmojaki/eval_type_backport/) | 0.3.0 | Like `typing._eval_type`, but lets older Python versions use newer typing features.
[expat](http://expat.sourceforge.net) | 2.7.3 | Expat XML parser library in C
[fairlearn](https://github.com/fairlearn/fairlearn) | 0.13.0 | Simple and easy fairness assessment and unfairness mitigation
[fastai](https://github.com/fastai/fastai) | 1.0.63 | fastai makes deep learning with PyTorch faster, more accurate, and easier
[fastavro](https://github.com/fastavro/fastavro) | 1.12.1 | Fast read/write of AVRO files
[fastprogress](https://github.com/fastai/fastprogress) | 0.2.3 | A fast and simple progress bar for Jupyter Notebook and console
[ffmpeg](http://www.ffmpeg.org/) | 8.0.1 | Cross-platform solution to record, convert and stream audio and video
...
[fmt](https://fmt.dev/latest/) | 11.2.0 | Provides a safe replacement for the printf family of functions
...
[frozenlist](https://github.com/aio-libs/frozenlist) | 1.8.0 | A list-like structure which implements collections.abc.MutableSequence
...
[geopandas](http://geopandas.org) | 1.1.3 | Geographic pandas extensions, base package
[geopandas-base](http://geopandas.org) | 1.1.3 | Geographic pandas extensions, metapackage
...
[gflags](https://github.com/gflags/gflags) | 2.3.0 | A C++ library that implements commandline flags processing
[giflib](http://giflib.sourceforge.net) | 5.2.2 | Library for reading and writing gif images
[glib](https://developer.gnome.org/glib/) | 2.86.5 | Provides core application building blocks for libraries and applications written in C
[glib-tools](https://developer.gnome.org/glib/) | 2.86.5 | Provides core application building blocks for libraries and applications written in C, command line tools
...
[google-auth](https://github.com/googleapis/google-auth-library-python) | 2.47.0 | Google authentication library for Python
...
[google-cloud-core](https://github.com/googleapis/python-cloud-core) | 2.5.0 | API Client library for Google Cloud: Core Helpers
...
[googleapis-common-protos](https://github.com/googleapis/google-cloud-python/tree/main/packages/googleapis-common-protos) | 1.72.0 | Common protobufs used in Google APIs
[googleapis-common-protos-grpc](https://github.com/googleapis/google-cloud-python/tree/main/packages/googleapis-common-protos) | 1.72.0 | Extra grpc requirements for googleapis-common-protos
...
[gsplat](https://github.com/nerfstudio-project/gsplat) | 1.5.3 | Python package for differentiable rasterization of gaussians
...
[h5netcdf](https://github.com/h5netcdf/h5netcdf) | 1.7.3 | Pythonic interface to netCDF4 via h5py
...
[huggingface_hub](https://github.com/huggingface/huggingface_hub) | 0.34.4 | Client library to download and publish models on the huggingface.co hub
...
[imageio](http://imageio.github.io) | 2.37.3 | A Python library for reading and writing image data
[inplace-abn](https://github.com/mapillary/inplace_abn) | 1.1.0 | In-Place Activated BatchNorm
[invoke](http://docs.pyinvoke.org) | 2.2.0 | Pythonic task execution
[iopath](https://github.com/facebookresearch/iopath) | 0.1.10 | Lightweight I/O abstraction library
[jaxtyping](https://github.com/google/jaxtyping) | 0.3.7 | Type annotations and runtime checking for shape and dtype of JAX arrays, and PyTrees.
[jiter](https://crates.io/crates/jiter) | 0.12.0 | Fast iterable JSON parser.
[jmespath](http://jmespath.org/) | 1.1.0 | Query language for JSON
[joblib](http://packages.python.org/joblib/) | 1.5.3 | Python function as pipeline jobs
...
[lark](https://github.com/lark-parser/lark) | 1.3.1 | a modern parsing library
...
[lazy_loader](https://scientific-python.org/specs/spec-0001/) | 0.5 | Easily load subpackages and functions on demand
[lcms2](https://www.littlecms.com) | 2.16 | The Little color management system
[libaec](https://gitlab.dkrz.de/k202009/libaec) | 1.1.6 | Adaptive entropy coding library
...
[libcublas](https://developer.nvidia.com/cublas) | 12.9.1.4 | An implementation of BLAS (Basic Linear Algebra Subprograms) on top of the NVIDIA CUDA runtime.
[libcudnn](https://developer.nvidia.com/cudnn) | 9.10.2.21 | NVIDIA's cuDNN deep neural network acceleration library
[libcudnn-dev](https://developer.nvidia.com/cudnn) | 9.10.2.21 | NVIDIA's cuDNN deep neural network acceleration library, development headers
[libcudss0](https://developer.nvidia.com/cudss) | 0.4.0.2 | The NVIDIA cuDSS runtime library.
[libcufft](https://developer.nvidia.com/cufft) | 11.4.1.4 | cuFFT native runtime libraries
[libcurand](https://developer.nvidia.com/curand) | 10.3.10.19 | cuRAND native runtime libraries
[libcurl](http://curl.haxx.se/) | 8.19.0 | Tool and library for transferring data with URL syntax
[libcusolver](https://developer.nvidia.com/cusolver) | 11.7.5.82 | CUDA Linear Solver Library
[libcusparse](https://developer.nvidia.com/cusparse) | 12.5.10.65 | CUDA Sparse Matrix Library
[libffi](https://sourceware.org/libffi/) | 3.5.2 | Portable foreign-function interface library
[libgd](http://libgd.github.io/) | 2.3.3 | Library for the dynamic creation of images
[libglib](https://developer.gnome.org/glib/) | 2.86.5 | Provides core application building blocks for libraries and applications written in C
...
[libmagma](https://icl.utk.edu/magma/) | 2.9.0 | Matrix Algebra on GPU and Multicore Architectures
[libnghttp2](https://www.nghttp2.org/) | 1.68.1 | HTTP/2 C library
[libnghttp3](https://nghttp2.org/nghttp3/) | 1.15.0 | nghttp3 is an implementation of RFC 9114 HTTP/3 mapping over QUIC and RFC 9204 QPACK in C.
[libnpp](https://developer.nvidia.com/npp) | 12.4.1.87 | NPP native runtime libraries
[libnvjitlink](https://developer.nvidia.com/cuda-toolkit) | 12.9.86 | CUDA nvJitLink library
[libnvjpeg](https://developer.nvidia.com/nvjpeg) | 12.4.0.76 | nvJPEG native runtime libraries
[libopencv](http://opencv.org/) | 4.13.0 | Computer vision and machine learning software library
...
[libspatialindex](http://libspatialindex.github.io) | 2.1.0 | Extensible framework for robust spatial indexing
[libsrt](https://github.com/Haivision/srt) | 1.5.3 | Secure, Reliable Transport
[libtorch](https://pytorch.org/) | 2.9.1 | PyTorch is an optimized tensor library for deep learning using GPUs and CPUs.
[libuv](http://libuv.org/) | 1.51.0 | Cross-platform asynchronous I/O
[libvpl](https://github.com/intel/libvpl) | 2.16.0 | Intel Video Processing Library
...
[libxgboost](https://github.com/dmlc/xgboost) | 3.2.0 | eXtreme Gradient Boosting
...
[llvmlite](https://github.com/numba/llvmlite) | 0.46.0 | A lightweight LLVM python binding for writing JIT compilers
[logical-unification](https://github.com/pythological/unification) | 0.4.7 | Logical unification in Python.
[lomond](https://github.com/wildfoundry/dataplicity-lomond) | 0.3.3 | Websocket Client Library
[mako](http://www.makotemplates.org) | 1.3.11 | Template library written in Python
...
[markdown](http://packages.python.org/Markdown/) | 3.8 | Python implementation of Markdown
...
[mistralai](https://github.com/mistralai/client-python) | 1.9.11 | Python client library for Mistral AI platform
...
[multidict](http://github.com/aio-libs/multidict) | 6.7.1 | Key-value pairs where keys are sorted and can reoccur
...
[munch](http://github.com/Infinidat/munch) | 4.0.0 | A dot-accessible dictionary (a la JavaScript objects)
[murmurhash](https://github.com/explosion/murmurhash/) | 1.0.15 | A non-cryptographic hash function
...
[ngtcp2](https://nghttp2.org/ngtcp2/) | 1.20.0 | Effort to implement IETF QUIC protocol.
[ninja_syntax](https://pypi.python.org/pypi/ninja_syntax/1.6.0) | 1.7.2 | Python module for generating .ninja files
[numba](http://numba.github.com) | 0.63.1 | NumPy aware dynamic Python compiler using LLVM
[nvidia-ml-py](https://developer.nvidia.com/nvidia-management-library-nvml) | 13.580.82 | Python bindings to the NVIDIA Management Library
...
[opencv](http://opencv.org/) | 4.13.0 | Computer vision and machine learning software library
[openjpeg](http://www.openjpeg.org/) | 2.5.4 | An open-source JPEG 2000 codec written in C
[optree](https://github.com/metaopt/optree) | 0.18.0 | Optimized PyTree Utilities
...
[pcre2](http://www.pcre.org/) | 10.47 | Regular expression pattern matching using the same syntax and semantics as Perl 5
...
[portalocker](https://github.com/WoLpH/portalocker) | 3.2.0 | Portalocker is a library to provide an easy API to file locking.
[preshed](https://github.com/explosion/preshed) | 3.0.12 | Cython Hash Table for Pre-Hashed Keys
[prettytable](https://github.com/jazzband/prettytable) | 2.1.0 | Display tabular data in a visually appealing ASCII table format
[proj4](https://proj4.org) | 9.8.1 | PROJ coordinate transformation software library
[propcache](https://github.com/aio-libs/propcache) | 0.4.1 | Accelerated property cache
[proto-plus](https://github.com/googleapis/proto-plus-python) | 1.27.1 | Beautiful, Pythonic protocol buffers.
[py-opencv](http://opencv.org/) | 4.13.0 | Computer vision and machine learning software library
[py-xgboost](https://github.com/dmlc/xgboost) | 3.2.0 | Python bindings for the scalable, portable and distributed gradient boosting XGBoost library
[pyasn1](https://github.com/etingof/pyasn1) | 0.6.3 | ASN.1 types and codecs
...
[pyclipper](https://github.com/fonttools/pyclipper) | 1.4.0 | Cython wrapper of Angus Johnson's Clipper library for polygon clipping
...
[pyopenssl](https://github.com/pyca/pyopenssl) | 26.0.0 | Python wrapper module around the OpenSSL library
...
[pytorch](http://pytorch.org/) | 2.9.1 | PyTorch is an optimized tensor library for deep learning using GPUs and CPUs
[pytorch-gpu](https://pytorch.org/) | 2.9.1 | PyTorch is an optimized tensor library for deep learning using GPUs and CPUs, GPU specific build
...
[ruamel_yaml](https://bitbucket.org/ruamel/yaml) | 0.17.21 | A YAML dumper / loader
[s3transfer](https://github.com/boto/s3transfer) | 0.16.0 | An Amazon S3 Transfer Manager
[safetensors](https://github.com/huggingface/safetensors) | 0.7.0 | Fast and Safe Tensor serialization
[sam-2](https://github.com/facebookresearch/segment-anything-2) | 1.0.0.20241215 | SAM 2: Segment Anything in Images and Videos
[samgeo](https://github.com/opengeos/segment-geospatial) | 3.7 | A collection of the essential packages to work with the Segment Geospatial (samgeo) stack.
...
[segment-geospatial](https://github.com/opengeos/segment-geospatial) | 1.2.2 | A Python package for segmenting geospatial data with the Segment Anything Model (SAM)
...
[shap](https://github.com/slundberg/shap) | 0.50.0 | A unified approach to explain the output of any machine learning model
...
[spacy](https://spacy.io/) | 3.8.11 | Industrial-strength Natural Language Processing
...
[spacy-loggers](https://github.com/explosion/spacy-loggers) | 1.0.5 | Alternate loggers for spaCy pipeline training
...
[srsly](http://github.com/explosion/srsly) | 2.5.2 | Modern high-performance serialization utilities for Python
...
[tabulate](https://bitbucket.org/astanin/python-tabulate) | 0.10.0 | Pretty-print tabular data in Python, a library and a command-line utility
[tenacity](https://github.com/jd/tenacity) | 9.1.4 | Retry a flaky function whenever an exception occurs until it works
[tensorboard](http://tensorflow.org/) | 2.20.0 | TensorBoard lets you watch Tensors Flow
[tensorboard-data-server](https://github.com/tensorflow/tensorboard) | 0.7.2 | Data server for TensorBoard
...
[termcolor](http://pypi.python.org/pypi/termcolor) | 3.2.0 | ANSII Color formatting for output in terminal
...
[threadpoolctl](https://github.com/joblib/threadpoolctl) | 3.6.0 | Python helpers to control the threadpools of native libraries
...
[torchvision](http://pytorch.org/) | 0.25.0 | Image and video datasets and models for torch deep learning
...
[typer-slim](https://github.com/tiangolo/typer) | 0.24.0 | A library for building CLI applications
...
[wadler-lindig](https://docs.kidger.site/wadler_lindig/) | 0.1.7 | A pretty printer which consumes less space and handles complex types
[wasabi](http://github.com/ines/wasabi) | 1.1.3 | A lightweight console printing and formatting toolkit
[weasel](https://github.com/explosion/weasel) | 0.4.3 | A small and easy workflow system
...
[werkzeug](http://werkzeug.pocoo.org/) | 3.1.6 | The Python WSGI Utility Library
[winloop](https://github.com/Vizonex/Winloop) | 0.3.1 | Windows version of uvloop
[wordcloud](https://github.com/amueller/word_cloud) | 1.9.5 | A little word cloud generator in Python
[xarray-einstats](https://github.com/arviz-devs/xarray-einstats) | 0.9.1 | Stats, linear algebra and einops for xarray.
[xgboost](https://github.com/dmlc/xgboost) | 3.2.0 | Scalable, portable and distributed Gradient Boosting (GBDT, GBRT or GBM) library
[xmltodict](https://github.com/martinblech/xmltodict) | 1.0.2 | Makes working with XML feel like you are working with JSON
[xxhash](https://www.xxhash.com) | 0.8.0 | Extremely fast hash algorithm
[xyzservices](https://github.com/geopandas/xyzservices) | 2026.3.0 | Source of XYZ tiles providers
[yapf](https://github.com/google/yapf) | 0.43.0 | A formatter for Python files
[yarl](https://github.com/aio-libs/yarl) | 1.23.0 | Yet another URL library
[zfp](https://computation.llnl.gov/projects/floating-point-compression) | 1.0.1 | Library for compressed numerical arrays that support high throughput read and write random access
